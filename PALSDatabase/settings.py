...
AUTH_USER_MODEL = 'loginPortal.User'
#LOGIN_URL = '/login/'
...
ROOT_URLCONF = 'PALSDatabase.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'PALSDatabase.wsgi.application'
...
INSTALLED_APPS = (
	...
	#'django.contrib.sites', throws error, but also isn't needed
